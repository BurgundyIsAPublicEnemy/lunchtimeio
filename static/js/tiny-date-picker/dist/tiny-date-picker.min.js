...
! function (t, e) {
	"object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : t.TinyDatePicker = e()
}(this, function () {
	"use strict";
	...
	function c(t) {
		...
		return t.lang = s(d, t.lang), t.parse = e, t.inRange = (a = (n = t).inRange, function (t, e) {
	...
	var y = {
		day: {
			onKeyDown: function (t, e) {
				var n = t.keyCode,
					a = n === v.left ? -1 : n === v.right ? 1 : n === v.up ? -7 : n === v.down ? 7 : 0;
				n === v.esc ? e.close() : a && (t.preventDefault(), e.setState({
			...
			render: function (r) {
				...
				return '<div class="dp-cal"><header class="dp-cal-header"><button tabindex="-1" type="button" class="dp-prev">Prev</button><button tabindex="-1" type="button" class="dp-cal-month">' + t.months[d] + '</button><button tabindex="-1" type="button" class="dp-cal-year">' + s.getFullYear() + '</button><button tabindex="-1" type="button" class="dp-next">Next</button></header><div class="dp-days">' + n.map(function (t, e) {
					...
					var e = t.getMonth() !== d,
						...
						a = t.getTime() === c,
						o = "dp-day";
					return o += e ? " dp-edge-day" : "", o += l(t, s) ? " dp-current" : "", o += l(t, u) ? " dp-selected" : "", o += n ? " dp-day-disabled" : "", o += a ? " dp-day-today" : "", '<button tabindex="-1" type="button" class="' + (o += " " + i.dateClass(t, r)) + '" data-date="' + t.getTime() + '">' + t.getDate() + "</button>"
                ...
                <div class="times">
                    ...
                    <span data-time="3">3</span>
                    <span data-time="4">4</span>
                    <span data-time="5">5</span>
                    <span data-time="6">6</span>
                    <span data-time="7">7</span>
                    <span data-time="8">8</span>
                    <span data-time="9">9</span>
                    <span data-time="10">10</span>
                    <span data-time="11">11</span>
                    <span data-time="12" class="active">12</span>
                    <span data-time="13">13</span>
                    <span data-time="14">14</span>
                    <span data-time="15">15</span>
                    <span data-time="16">16</span>
                    <span data-time="17">17</span>
                    <span data-time="18">18</span>
                    <span data-time="19">19</span>
                    <span data-time="20">20</span>
                    <span data-time="21">21</span>
                    <span data-time="22">22</span>
                    <span data-time="23">23</span>
                </div>
            </footer>` +'</div><footer class="dp-cal-footer"><button tabindex="-1" type="button" class="dp-today">' + t.today + '</button><button tabindex="-1" type="button" class="dp-clear">' + t.clear + '</button><button tabindex="-1" type="button" class="dp-close">' + t.close + "</button></footer></div>"
			}
		},
		year: {
			render: function (t) {
			...
			onKeyDown: function (t, e) {
				var n = t.keyCode,
					a = e.opts,
					o = n === v.left || n === v.up ? 1 : n === v.right || n === v.down ? -1 : 0;
				if (n === v.esc) e.setState({
					view: "day"
				});
				else if (o) {
					t.preventDefault();
		...
		month: {
			onKeyDown: function (t, e) {
				var n = t.keyCode,
					a = n === v.left ? -1 : n === v.right ? 1 : n === v.up ? -3 : n === v.down ? 3 : 0;
				n === v.esc ? e.setState({
					view: "day"
				}) : a && (t.preventDefault(), e.setState({
					hilightedDate: r(e.state.hilightedDate, a, !0)
				}))
			},
			onClick: {
				"dp-month": function (t, e) {
					e.setState({
						hilightedDate: (n = e.state.hilightedDate, a = parseInt(t.target.getAttribute("data-month")), r(n, a - n.getMonth())),
						view: "day"
					});
					var n, a
				}
			...
			c = {
				...
				open: function () {
					...
					d || (c.el || (c.el = (t = a, e = c.containerHTML, (n = document.createElement("div")).className = t.mode, n.innerHTML = e, n), function (a) {
						...
						t.ontouchstart = h, g("blur", e, p(150, function () {
							a.hasFocus() || a.close(!0)
						})), g("keydown", t, function (t) {
							t.keyCode === v.enter ? n(t) : a.currentView().onKeyDown(t, a)
						}), g("mousedown", e, function (t) {
							t.target.focus && t.target.focus(), document.activeElement !== t.target && (t.preventDefault(), b(a))
						}), g("click", t, n)
					}(c)), i = f(c.computeSelectedDate(), a.min, a.max), c.state.hilightedDate = i || a.hilightedDate, c.state.view = "day", c.attachToDom(), c.render(), r("open"))
				},
				isVisible: function () {
				...
				render: function () {
					if (c.el && c.el.firstChild) {
						...
						e && (c.el.firstChild.innerHTML = e), c.adjustPosition(), (t || c.shouldFocusOnRender) && b(c)
					}
				},
				setState: function (t) {
